...
*/
    ...
    /***/ 13: /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      function _possibleConstructorReturn(self, call) {
        ...
        return Object(
          _assertThisInitialized__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]
        )(self);
      }
...
*/
    ...
    /***/ 343: /***/ function(
      ...
      __webpack_require__.d(
        actions_namespaceObject,
        "__experimentalSubscribeSources",
        function() {
      ...
      __webpack_require__.d(
        store_selectors_namespaceObject,
          ...
          switch (action.type) {
            case "RECEIVE_REUSABLE_BLOCKS": {
              return Object(objectSpread["a" /* default */])(
                {},
                state,
                Object(external_lodash_["keyBy"])(action.results, "id")
              );
            }
      ...
      /* harmony default export */ var reducer = redux_optimist_default()(
      ...
      function getNotificationArgumentsForSaveFail(data) {
        ...
        var noticeMessage =
          !isPublished && publishStatus.indexOf(edits.status) !== -1
            ...
            : Object(external_this_wp_i18n_["__"])("Updating failed."); // Check if message string contains HTML. Notice text is currently only
        // supported as plaintext, and stripping the tags may muddle the meaning.

        if (error.message && !/<\/?[^>]*>/.test(error.message)) {
          noticeMessage = Object(external_this_wp_i18n_["sprintf"])(
            Object(external_this_wp_i18n_["__"])("%1$s Error message: %2$s"),
            noticeMessage,
            error.message
          );
        }
      ...
      var serializeBlocks = memize_default()(
        function(blocksForSerialization) {
          // A single unmodified default block is assumed to
          // be equivalent to an empty post.
          if (
            blocksForSerialization.length === 1 &&
            Object(external_this_wp_blocks_["isUnmodifiedDefaultBlock"])(
              blocksForSerialization[0]
            )
          ) {
            blocksForSerialization = [];
          }

          var content = Object(external_this_wp_blocks_["serialize"])(
            blocksForSerialization
      ...
      var controls = {
        AWAIT_NEXT_STATE_CHANGE: Object(
          external_this_wp_data_["createRegistryControl"]
        )(function(registry) {
          return function() {
        ...
        GET_REGISTRY: Object(external_this_wp_data_["createRegistryControl"])(
          function(registry) {
            return function() {
              return registry;
            };
        ...
        return regenerator_default.a.wrap(function getDependencies$(_context) {
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                _context.next = 2;
                return Object(external_this_wp_dataControls_["select"])(
                  "core/editor",
                  "getEditedPostAttribute",
                  "meta"
                );
          ...
          while (1) {
            switch ((_context2.prev = _context2.next)) {
              case 0:
                _context2.next = 2;
                return actions_editPost({
                  meta: Object(defineProperty["a" /* default */])(
                    {},
                    schema.meta,
                    value
                  )
      ...
      function getBlocksWithSourcedAttributes(blocks) {
        ...
        return regenerator_default.a.wrap(
          function getBlocksWithSourcedAttributes$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  _context.next = 2;
                ...
                case 5:
                  blockSourceDependencies = lastBlockSourceDependenciesByRegistry.get(
                    registry
                  );
                ...
                case 12:
                  ...
                  (_i = 0),
                    (_Object$entries = Object.entries(blockType.attributes));
                ...
                case 14:
                  ...
                  if (
                    !(
                      !block_sources_namespaceObject[schema.source] ||
                      !block_sources_namespaceObject[schema.source].apply
                    )
                  ) {
                    _context.next = 18;
                    break;
                ...
                case 20:
                  dependencies = blockSourceDependencies.get(
                    block_sources_namespaceObject[schema.source]
                  );
                  sourcedAttributeValue = block_sources_namespaceObject[
                    schema.source
                  ].apply(schema, dependencies); // It's only necessary to apply the value if it differs from the
                  // block's locally-assigned value, to avoid needlessly resetting
                  // the block editor.

                  if (
                    !(sourcedAttributeValue === block.attributes[attributeName])
                  ) {
                    _context.next = 24;
                    break;
                  }
                ...
                case 30:
                  ...
                  return _context.delegateYield(
                    getBlocksWithSourcedAttributes(block.innerBlocks),
                    "t0",
                    32
                  );
      ...
      function resetLastBlockSourceDependencies() {
        ...
        return regenerator_default.a.wrap(
          function resetLastBlockSourceDependencies$(_context2) {
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                case 0:
                  sourcesToUpdate =
                    _args2.length > 0 && _args2[0] !== undefined
                      ? _args2[0]
                      : Object.values(block_sources_namespaceObject);
                ...
                case 5:
                  ...
                  if (!lastBlockSourceDependenciesByRegistry.has(registry)) {
                    lastBlockSourceDependenciesByRegistry.set(
                      registry,
                      new WeakMap()
                    );
                  }

                  lastBlockSourceDependencies = lastBlockSourceDependenciesByRegistry.get(
                    registry
                  );
            ...
            switch ((_context3.prev = _context3.next)) {
              ...
              case 6:
                return _context3.delegateYield(
                  resetLastBlockSourceDependencies(),
                  "t0",
                  7
                );
      ...
      function __experimentalSubscribeSources() {
        ...
        return regenerator_default.a.wrap(
          function __experimentalSubscribeSources$(_context4) {
            while (1) {
          ...
          while (1) {
            switch ((_context5.prev = _context5.next)) {
              ...
              case 3:
                ...
                _context5.next = 6;
                return Object(external_this_wp_dataControls_["dispatch"])(
                  "core",
                  "receiveAutosaves",
                  postId,
                  newAutosave
        ...
        return regenerator_default.a.wrap(function savePost$(_context7) {
          while (1) {
            switch ((_context7.prev = _context7.next)) {
              case 0:
                options =
                  _args8.length > 0 && _args8[0] !== undefined ? _args8[0] : {};
                _context7.next = 3;
                return Object(external_this_wp_dataControls_["select"])(
                  STORE_KEY,
                  "isEditedPostSaveable"
              ...
              case 30:
                ...
                _context7.next = 36;
                return external_this_wp_dataControls_["dispatch"].apply(
                  void 0,
              ...
              case 46:
                ...
                return external_this_wp_dataControls_["dispatch"].apply(
                  ...
                  ["core/notices", "createSuccessNotice"].concat(
                    Object(toConsumableArray["a" /* default */])(_args7)
                  )
                );
      ...
      function actions_experimentalLocalAutosave() {
        ...
        return regenerator_default.a.wrap(function __experimentalLocalAutosave$(
          _context11
        ) {
          while (1) {
      ...
      function actions_resetEditorBlocks(blocks) {
        ...
        return regenerator_default.a.wrap(function resetEditorBlocks$(
          _context14
        ) {
          while (1) {
            switch ((_context14.prev = _context14.next)) {
              ...
              case 8:
                ...
                (_Object$entries2$_i = Object(slicedToArray["a" /* default */])(
                  _Object$entries2[_i3],
                  2
                )),
                  (clientId = _Object$entries2$_i[0]),
                  (attributes = _Object$entries2$_i[1]);
                _context14.next = 12;
                return Object(external_this_wp_dataControls_["select"])(
                  "core/block-editor",
                  "getBlockName",
              ...
              case 20:
                ...
                (_Object$entries3$_i = Object(slicedToArray["a" /* default */])(
                  _Object$entries3[_i4],
                  2
                )),
                  (attributeName = _Object$entries3$_i[0]),
                  (newAttributeValue = _Object$entries3$_i[1]);
              ...
              case 24:
                ...
                return _context14.delegateYield(
                  source.update(schema, newAttributeValue),
                  "t0",
                  28
                );
              ...
              case 35:
                return _context14.delegateYield(
                  resetLastBlockSourceDependencies(Array.from(updatedSources)),
                  "t1",
                  36
                );
              ...
              case 36:
                return _context14.delegateYield(
                  getBlocksWithSourcedAttributes(blocks),
                  "t2",
                  37
                );
              ...
              case 54:
                ...
                edits.content = function(_ref3) {
                  var _ref3$blocks = _ref3.blocks,
                    blocksForSerialization =
                      _ref3$blocks === void 0 ? [] : _ref3$blocks;
              ...
              while (1) {
                switch ((_context15.prev = _context15.next)) {
                  case 0:
                    ...
                    for (
                      _len = _args16.length, args = new Array(_len), _key = 0;
                      _key < _len;
                      _key++
                    ) {
      ...
      function selectors_getEditedPostPreviewLink(state) {
        ...
        if (!previewLink) {
          ...
          if (previewLink) {
            previewLink = Object(external_this_wp_url_["addQueryArgs"])(
              previewLink,
              {
                preview: true
              }
      ...
      var selectors_experimentalGetReusableBlocks = Object(
        rememo["a" /* default */]
      )(
        function(state) {
      ...
      function selectors_isPublishingPost(state) {
        ...
        return (
          ...
          !selectors_isCurrentPostPublished(
            null,
            stateBeforeRequest.currentPost
          )
        );
      }
      /**
      ...
      var selectors_getBlocksByClientId = getBlockEditorSelector(
        "getBlocksByClientId"
      );
      /**
      ...
      var selectors_canInsertBlockType = getBlockEditorSelector(
        "canInsertBlockType"
      );
      /**
                    ...
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 5:
                        ...
                        (_getReusableBlock = __experimentalGetReusableBlock(
                          ...
                          (content = _getReusableBlock.content),
      ...
      var reusable_blocks_convertBlockToStatic = function convertBlockToStatic(
        ...
        var newBlocks = Object(external_this_wp_blocks_["parse"])(
      ...
      function applyMiddlewares(store) {
        ...
        enhancedDispatch = refx_default()(effects)(middlewareAPI)(
          store.dispatch
        );
      ...
      var storeConfig = {
        ...
        controls: Object(objectSpread["a" /* default */])(
          {},
          external_this_wp_dataControls_["controls"],
          store_controls
        )
      };
      var store_store = Object(external_this_wp_data_["registerStore"])(
        STORE_KEY,
        Object(objectSpread["a" /* default */])({}, storeConfig, {
          persist: ["preferences"]
        })
      );
      ...
      var block_fetchReusableBlocks = Object(external_lodash_["once"])(
        function() {
          Object(external_this_wp_data_["dispatch"])(
            "core/editor"
          ).__experimentalFetchReusableBlocks();
            ...
            },
            {
              ...
              value: function toggleTimer(isPendingSave) {
                ...
                var _this$props2 = this.props,
                  ...
                  shouldThrottle =
                    _this$props2$shouldTh === void 0
                      ? false
                      : _this$props2$shouldTh; // By default, AutosaveMonitor will wait for a pause in editing before
      ...
      function EditorNotices(_ref) {
        ...
        return Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            external_this_wp_components_["SnackbarList"],
            {
                  ...
                  external_this_wp_blockEditor_["Warning"],
                  {
                    ...
                    actions: [
                      Object(external_this_wp_element_["createElement"])(
                        ...
                        Object(external_this_wp_i18n_["__"])("Attempt Recovery")
                      ),
                      Object(external_this_wp_element_["createElement"])(
      ...
      function useAutosaveNotice() {
        var _useSelect = Object(external_this_wp_data_["useSelect"])(function(
            select
          ) {
            ...
            return {
              ...
              getEditedPostAttribute: select("core/editor")
                .getEditedPostAttribute,
              remoteAutosave: select("core").getAutosave(
                postType,
                _postId,
                user.id
              ),
              hasFetchedAutosave:
                select("core").hasFetchedAutosaves(postType, _postId) && user.id
            };
          }),
                ...
                actions: [
                  {
                    ...
                    onClick: function onClick() {
                      ...
                      resetEditorBlocks(
                        Object(external_this_wp_blocks_["parse"])(edits.content)
                      );
      ...
      function useAutosavePurge() {
        var _useSelect2 = Object(external_this_wp_data_["useSelect"])(function(
            select
          ) {
            return {
        ...
        var lastIsAutosaving = Object(external_this_wp_element_["useRef"])(
          isAutosaving
        );
        Object(external_this_wp_element_["useEffect"])(
          function() {
      ...
      function LocalAutosaveMonitor() {
        var _useDispatch3 = Object(external_this_wp_data_["useDispatch"])(
            "core/editor"
          ),
          __experimentalLocalAutosave =
            _useDispatch3.__experimentalLocalAutosave;

        var autosave = Object(external_this_wp_element_["useCallback"])(
          function() {
        ...
        var _useSelect3 = Object(external_this_wp_data_["useSelect"])(function(
            select
          ) {
            return {
      ...
      /* harmony default export */ var local_autosave_monitor = Object(
        external_this_wp_compose_["ifCondition"]
      ...
      function PostSwitchToDraftButton(_ref) {
        ...
        return Object(external_this_wp_element_["createElement"])(
          ...
          isMobileViewport
            ? Object(external_this_wp_i18n_["__"])("Draft")
      ...
      var withRegistryProvider = Object(
        ...
        return Object(external_this_wp_data_["withRegistry"])(function(props) {
          ...
          Object(external_this_wp_element_["useEffect"])(
            function() {
              var newRegistry = Object(
                external_this_wp_data_["createRegistry"]
              )(
                {
                  "core/block-editor":
                    external_this_wp_blockEditor_["storeConfig"]
                },
                registry
              );
          ...
          return Object(external_this_wp_element_["createElement"])(
            external_this_wp_data_["RegistryProvider"],
            {
              value: subRegistry
            },
            Object(external_this_wp_element_["createElement"])(
      ...
      /* harmony default export */ var reusable_block_convert_button = Object(
        external_this_wp_compose_["compose"]
      )([
        Object(external_this_wp_data_["withSelect"])(function(select, _ref2) {
          ...
          var isReusable =
            blocks.length === 1 &&
            blocks[0] &&
            Object(external_this_wp_blocks_["isReusableBlock"])(blocks[0]) &&
            !!getReusableBlock(blocks[0].attributes.ref); // Show 'Convert to Regular Block' when selected block is a reusable block

          var isVisible =
            isReusable || // Hide 'Add to Reusable Blocks' when reusable blocks are disabled
            (canInsertBlockType("core/block") &&
            Object(external_lodash_["every"])(blocks, function(block) {
              return (
                ...
                Object(external_this_wp_blocks_["hasBlockSupport"])(
                  block.name,
                  "reusable",
                  true
                )
        ...
        Object(external_this_wp_data_["withDispatch"])(function(
          ...
          var clientIds = _ref3.clientIds,
            ...
            onToggle =
              _ref3$onToggle === void 0
                ? external_lodash_["noop"]
                : _ref3$onToggle;

          var _dispatch = dispatch("core/editor"),
            convertBlockToReusable =
              _dispatch.__experimentalConvertBlockToReusable,
      ...
      /* harmony default export */ var reusable_block_delete_button = Object(
        external_this_wp_compose_["compose"]
      )([
        Object(external_this_wp_data_["withSelect"])(function(select, _ref2) {
          var clientId = _ref2.clientId;
          ...
          var reusableBlock =
            block && Object(external_this_wp_blocks_["isReusableBlock"])(block)
        ...
        Object(external_this_wp_data_["withDispatch"])(function(
          ...
          return {
            onDelete: function onDelete() {
              ...
              // eslint-disable-next-line no-alert
              var hasConfirmed = window.confirm(
                Object(external_this_wp_i18n_["__"])(
      ...
      /* harmony default export */ var reusable_blocks_buttons = Object(
        external_this_wp_data_["withSelect"]
      )(function(select) {
        var _select = select("core/block-editor"),
      ...
      var GroupSVG = Object(external_this_wp_element_["createElement"])(
        external_this_wp_components_["SVG"],
        {
          width: "20",
          height: "20",
        ...
        Object(external_this_wp_element_["createElement"])(
          external_this_wp_components_["Path"],
          {
            ...
            clipRule: "evenodd",
            d:
              "M8 5a1 1 0 0 0-1 1v3H6a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3h1a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H8zm3 6H7v2h4v-2zM9 9V7h4v2H9z"
          }
        ),
        Object(external_this_wp_element_["createElement"])(
          external_this_wp_components_["Path"],
          {
            ...
            clipRule: "evenodd",
            d:
              "M1 3a2 2 0 0 0 1 1.732v10.536A2 2 0 1 0 4.732 18h10.536A2 2 0 1 0 18 15.268V4.732A2 2 0 1 0 15.268 2H4.732A2 2 0 0 0 1 3zm14.268 1H4.732A2.01 2.01 0 0 1 4 4.732v10.536c.304.175.557.428.732.732h10.536a2.01 2.01 0 0 1 .732-.732V4.732A2.01 2.01 0 0 1 15.268 4z"
          }
        )
      );
      var Group = Object(external_this_wp_element_["createElement"])(
        external_this_wp_components_["Icon"],
        {
          icon: GroupSVG
        }
      );
      var UngroupSVG = Object(external_this_wp_element_["createElement"])(
        external_this_wp_components_["SVG"],
        {
          width: "20",
          height: "20",
        ...
        Object(external_this_wp_element_["createElement"])(
          external_this_wp_components_["Path"],
          {
            ...
            clipRule: "evenodd",
            d:
              "M9 2H15C16.1 2 17 2.9 17 4V7C17 8.1 16.1 9 15 9H9C7.9 9 7 8.1 7 7V4C7 2.9 7.9 2 9 2ZM9 7H15V4H9V7Z"
          }
        ),
        Object(external_this_wp_element_["createElement"])(
          external_this_wp_components_["Path"],
          {
            ...
            clipRule: "evenodd",
            d:
              "M5 11H11C12.1 11 13 11.9 13 13V16C13 17.1 12.1 18 11 18H5C3.9 18 3 17.1 3 16V13C3 11.9 3.9 11 5 11ZM5 16H11V13H5V16Z"
          }
        )
      );
      var Ungroup = Object(external_this_wp_element_["createElement"])(
        external_this_wp_components_["Icon"],
        {
          icon: UngroupSVG
        }
      ...
      function ConvertToGroupButton(_ref) {
        var onConvertToGroup = _ref.onConvertToGroup,
          ...
          isUngroupable =
            _ref$isUngroupable === void 0 ? false : _ref$isUngroupable;
        return Object(external_this_wp_element_["createElement"])(
          external_this_wp_element_["Fragment"],
          null,
          isGroupable &&
            Object(external_this_wp_element_["createElement"])(
              ...
              Object(external_this_wp_i18n_["_x"])("Group", "verb")
            ),
          isUngroupable &&
            Object(external_this_wp_element_["createElement"])(
              external_this_wp_components_["MenuItem"],
      ...
      /* harmony default export */ var convert_button = Object(
        external_this_wp_compose_["compose"]
      )([
        Object(external_this_wp_data_["withSelect"])(function(select, _ref2) {
          var clientIds = _ref2.clientIds;
          ...
          var rootClientId =
            clientIds && clientIds.length > 0
              ...
              : undefined;
          var groupingBlockAvailable = canInsertBlockType(
            groupingBlockName,
            rootClientId
          );
          var blocksSelection = getBlocksByClientId(clientIds);
          var isSingleGroupingBlock =
            blocksSelection.length === 1 &&
            blocksSelection[0] &&
            blocksSelection[0].name === groupingBlockName; // Do we have
          ...
          var isGroupable =
            ...
            !isSingleGroupingBlock; // Do we have a single Group Block selected and does that group have inner blocks?
        ...
        Object(external_this_wp_data_["withDispatch"])(function(
          ...
          var clientIds = _ref3.clientIds,
            ...
            blocksSelection =
              _ref3$blocksSelection === void 0 ? [] : _ref3$blocksSelection,
          ...
          return {
            onConvertToGroup: function onConvertToGroup() {
              ...
              var newBlocks = Object(
                external_this_wp_blocks_["switchToBlockType"]
              )(blocksSelection, groupingBlockName);
      ...
      /* harmony default export */ var convert_to_group_buttons = Object(
        external_this_wp_data_["withSelect"]
      )(function(select) {
        var _select = select("core/block-editor"),
          getSelectedBlockClientIds = _select.getSelectedBlockClientIds;
      ...
      var reducer_downloadableBlocks = function downloadableBlocks() {
        ...
        switch (action.type) {
          ...
          case "REMOVE_INSTALLED_BLOCK_TYPE":
            return Object(objectSpread["a" /* default */])({}, state, {
              installedBlockTypes: state.installedBlockTypes.filter(function(
                blockType
              ) {
      ...
      /* harmony default export */ var store_reducer = Object(
        external_this_wp_data_["combineReducers"]
      )({
      ...
      function selectors_getInstalledBlockTypes(state) {
        return Object(external_lodash_["get"])(
          state,
          ["downloadableBlocks", "installedBlockTypes"],
          []
        );
      }
      ...
      var controls_controls = {
          ...
          function(registry) {
            return function(_ref) {
              ...
              var storeName = _ref.storeName,
                ...
                args = _ref.args;
              return (_registry$select = registry.select(storeName))[
                selectorName
              ].apply(
                _registry$select,
                Object(toConsumableArray["a" /* default */])(args)
          ...
          function(registry) {
            return function(_ref2) {
              ...
              var storeName = _ref2.storeName,
                ...
                args = _ref2.args;
              return (_registry$dispatch = registry.dispatch(storeName))[
                dispatcherName
              ].apply(
                _registry$dispatch,
                Object(toConsumableArray["a" /* default */])(args)
        ...
        API_FETCH: function API_FETCH(_ref3) {
          ...
          return external_this_wp_apiFetch_default()(
            Object(objectSpread["a" /* default */])({}, request)
          );
        },
 ...
 */
          ...
          function downloadBlock$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                ...
                case 5:
                  registeredBlocks = Object(
                    external_this_wp_blocks_["getBlockTypes"]
                  )();
      ...
      /* harmony default export */ var resolvers = {
        getDownloadableBlocks:
          /*#__PURE__*/
          regenerator_default.a.mark(function getDownloadableBlocks(
            filterValue
          ) {
            var results, blocks;
            return regenerator_default.a.wrap(
                ...
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 5:
                      _context.next = 7;
                      return apiFetch({
                        path: "__experimental/block-directory/search?term=".concat(
                          filterValue
                        )
                      });
      ...
      var build_module_store_store = Object(
        external_this_wp_data_["registerStore"]
      )(MODULE_KEY, store_storeConfig);
        ...
        return Object(external_this_wp_element_["createElement"])(
          "div",
          {
            "aria-label": Object(external_this_wp_i18n_["sprintf"])(
              Object(external_this_wp_i18n_["__"])("%s out of 5 stars"),
              stars
            )
          },
      ...
      function DownloadableBlockHeader(_ref) {
        ...
        return Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            ...
            Object(external_this_wp_element_["createElement"])(block_ratings, {
              rating: rating,
      ...
      function DownloadableBlockAuthorInfo(_ref) {
        ...
        return Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            ...
            Object(external_this_wp_i18n_["sprintf"])(
              Object(external_this_wp_i18n_["__"])("Authored by %s"),
              author
            )
          ),
          Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            ...
            Object(external_this_wp_element_["createElement"])(
              ...
              Object(external_this_wp_element_["createElement"])(
                ...
                {
                  "aria-label": Object(external_this_wp_i18n_["sprintf"])(
                    Object(external_this_wp_i18n_["__"])("Updated %s"),
                    humanizedUpdated
                  )
                },
                humanizedUpdated
      ...
      function DownloadableBlocksList(_ref) {
        var items = _ref.items,
          ...
          onHover =
            _ref$onHover === void 0 ? external_lodash_["noop"] : _ref$onHover,
          children = _ref.children,
              ...
              items.map(function(item) {
                return Object(external_this_wp_element_["createElement"])(
                  downloadable_block_list_item,
                  {
                    key: item.id,
                    className: Object(
                      external_this_wp_blocks_["getBlockMenuDefaultClassName"]
                    )(item.id),
                    icons: item.icons,
                    onClick: function onClick() {
      ...
      /* harmony default export */ var downloadable_blocks_list = Object(
        external_this_wp_compose_["compose"]
      )(
        Object(external_this_wp_data_["withDispatch"])(function(
          dispatch,
                      ...
                      actions: [
                        ...
                        },
                        {
                          ...
                          onClick: function onClick() {
                            ...
                            Object(
                              external_this_wp_blocks_["unregisterBlockType"]
                            )(item.name);
                          }
                        }
                      ]
      ...
      function DownloadableBlocksPanel(_ref) {
        ...
        if (!hasPermission) {
          ...
          return Object(external_this_wp_element_["createElement"])(
            ...
            Object(external_this_wp_i18n_["__"])(
              "No blocks found in your library."
            ),
            Object(external_this_wp_element_["createElement"])("br", null),
            Object(external_this_wp_i18n_["__"])(
      ...
      /* harmony default export */ var downloadable_blocks_panel = Object(
        ...
        Object(external_this_wp_data_["withSelect"])(function(select, _ref2) {
          ...
          var _select = select("core/block-directory"),
            ...
            isRequestingDownloadableBlocks =
              _select.isRequestingDownloadableBlocks;

          var hasPermission = hasInstallBlocksPermission();
          var downloadableItems = hasPermission
      ...
      function InserterMenuDownloadableBlocksPanel() {
        ...
        var debouncedSetFilterValue = Object(external_lodash_["debounce"])(
          setFilterValue,
          400
        );
        return Object(external_this_wp_element_["createElement"])(
          external_this_wp_blockEditor_["__experimentalInserterMenuExtension"],
          null,
          function(_ref) {
                  ...
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 2:
                      ...
                      return _context.abrupt(
                        "return",
                        Object(external_lodash_["map"])(posts, function(post) {
                          return {
                            id: post.id,
                            url: post.url,
                            title:
          ...
          Object(createClass["a" /* default */])(EditorProvider, [
              ...
              value: function getBlockEditorSettings(
                ...
                return Object(objectSpread["a" /* default */])(
                  ...
                  ]),
                  {
                    ...
                    __experimentalMediaUpload: hasUploadPermissions
                      ? media_upload
                      : undefined,
            ...
            },
            {
              ...
              value: function componentDidMount() {
                ...
                var updatedStyles = Object(
                  external_this_wp_blockEditor_["transformStyles"]
                )(this.props.settings.styles, ".editor-styles-wrapper");
              ...
              value: function componentDidUpdate(prevProps) {
                ...
                if (
                  !Object(external_lodash_["isEqual"])(
                    ...
                    prevProps.downloadableBlocksToUninstall
                  )
                ) {
                  this.props.downloadableBlocksToUninstall.forEach(function(
                    blockType
                  ) {
                    _this2.props.uninstallBlock(
                      blockType,
                      external_lodash_["noop"],
                      function() {
                        _this2.props.createWarningNotice(
                          Object(external_this_wp_i18n_["__"])(
                            "Block previews can't uninstall."
                          ),
                          {
                    ...
                    Object(external_this_wp_blocks_["unregisterBlockType"])(
                      blockType.name
                    );
                  });
                }
            ...
            },
            {
              ...
              value: function render() {
                var _this$props = this.props,
                  canUserUseUnfilteredHTML =
                    _this$props.canUserUseUnfilteredHTML,
                  children = _this$props.children,
                ...
                return Object(external_this_wp_element_["createElement"])(
                  ...
                  children,
                  Object(external_this_wp_element_["createElement"])(
                    reusable_blocks_buttons,
                    null
                  ),
                  Object(external_this_wp_element_["createElement"])(
                    convert_to_group_buttons,
                    null
                  ),
      ...
      /* harmony default export */ var provider = Object(
        ...
        Object(external_this_wp_data_["withSelect"])(function(select) {
          ...
          var downloadableBlocksToUninstall = Object(
            external_lodash_["differenceBy"]
          )(getInstalledBlockTypes(), getBlocks(), "name");
          return {
        ...
        Object(external_this_wp_data_["withDispatch"])(function(dispatch) {
          var _dispatch = dispatch("core/editor"),
            ...
            __experimentalTearDownEditor =
              _dispatch.__experimentalTearDownEditor;
      ...
      var external_this_wp_serverSideRender_default = /*#__PURE__*/ __webpack_require__.n(
        external_this_wp_serverSideRender_
      );
      ...
      function deprecateComponent(name, Wrapped) {
        var staticsToHoist =
          arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : [];
        var Component = Object(external_this_wp_element_["forwardRef"])(
          function(props, ref) {
      ...
      RichText.isEmpty = deprecateFunction(
        "RichText.isEmpty",
        external_this_wp_blockEditor_["RichText"].isEmpty
      );

      var Autocomplete = deprecateComponent(
        "Autocomplete",
        external_this_wp_blockEditor_["Autocomplete"]
      );
      var AlignmentToolbar = deprecateComponent(
        "AlignmentToolbar",
        external_this_wp_blockEditor_["AlignmentToolbar"]
      );
      ...
      var BlockEdit = deprecateComponent(
        "BlockEdit",
        external_this_wp_blockEditor_["BlockEdit"]
      );
      var BlockEditorKeyboardShortcuts = deprecateComponent(
        "BlockEditorKeyboardShortcuts",
        external_this_wp_blockEditor_["BlockEditorKeyboardShortcuts"]
      );
      var BlockFormatControls = deprecateComponent(
        "BlockFormatControls",
        external_this_wp_blockEditor_["BlockFormatControls"],
        ["Slot"]
      );
      ...
      var BlockMover = deprecateComponent(
        "BlockMover",
        external_this_wp_blockEditor_["BlockMover"]
      );
      ...
      var BlockSettingsMenu = deprecateComponent(
        "BlockSettingsMenu",
        external_this_wp_blockEditor_["BlockSettingsMenu"]
      );
      ...
      var ColorPalette = deprecateComponent(
        "ColorPalette",
        external_this_wp_blockEditor_["ColorPalette"]
      );
      var ContrastChecker = deprecateComponent(
        "ContrastChecker",
        external_this_wp_blockEditor_["ContrastChecker"]
      );
      ...
      var DefaultBlockAppender = deprecateComponent(
        ...
        external_this_wp_blockEditor_["DefaultBlockAppender"]
      );
      var FontSizePicker = deprecateComponent(
        "FontSizePicker",
        external_this_wp_blockEditor_["FontSizePicker"]
      );
      ...
      var InspectorAdvancedControls = deprecateComponent(
        ...
        external_this_wp_blockEditor_["InspectorAdvancedControls"],
        ["Slot"]
      );
      var InspectorControls = deprecateComponent(
        "InspectorControls",
        external_this_wp_blockEditor_["InspectorControls"],
        ["Slot"]
      );
      ...
      var PlainText = deprecateComponent(
        "PlainText",
        external_this_wp_blockEditor_["PlainText"]
      );
      ...
      var MediaPlaceholder = deprecateComponent(
        "MediaPlaceholder",
        external_this_wp_blockEditor_["MediaPlaceholder"]
      );
      ...
      var MultiBlocksSwitcher = deprecateComponent(
        "MultiBlocksSwitcher",
        external_this_wp_blockEditor_["MultiBlocksSwitcher"]
      );
      ...
      var SkipToSelectedBlock = deprecateComponent(
        "SkipToSelectedBlock",
        external_this_wp_blockEditor_["SkipToSelectedBlock"]
      );
      ...
      var URLInputButton = deprecateComponent(
        "URLInputButton",
        external_this_wp_blockEditor_["URLInputButton"]
      );
      ...
      var createCustomColorsHOC = deprecateFunction(
        ...
        external_this_wp_blockEditor_["createCustomColorsHOC"]
      );
      var getColorClassName = deprecateFunction(
        "getColorClassName",
        external_this_wp_blockEditor_["getColorClassName"]
      );
      var getColorObjectByAttributeValues = deprecateFunction(
        "getColorObjectByAttributeValues",
        external_this_wp_blockEditor_["getColorObjectByAttributeValues"]
      );
      var getColorObjectByColorValue = deprecateFunction(
        "getColorObjectByColorValue",
        external_this_wp_blockEditor_["getColorObjectByColorValue"]
      );
      var getFontSize = deprecateFunction(
        "getFontSize",
        external_this_wp_blockEditor_["getFontSize"]
      );
      var getFontSizeClass = deprecateFunction(
        "getFontSizeClass",
        external_this_wp_blockEditor_["getFontSizeClass"]
      );
      var withColorContext = deprecateFunction(
        "withColorContext",
        external_this_wp_blockEditor_["withColorContext"]
      );
      var withColors = deprecateFunction(
        "withColors",
        external_this_wp_blockEditor_["withColors"]
      );
      ...
      /* concated harmony reexport LocalAutosaveMonitor */ __webpack_require__.d(
        __webpack_exports__,
      ...
      /* concated harmony reexport __unstableRichTextInputEvent */ __webpack_require__.d(
        __webpack_exports__,
        "__unstableRichTextInputEvent",
        function() {
      ...
      /* concated harmony reexport storeConfig */ __webpack_require__.d(
        __webpack_exports__,
        "storeConfig",
        function() {
          return storeConfig;
