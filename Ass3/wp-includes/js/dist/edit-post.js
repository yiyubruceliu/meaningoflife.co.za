...
*/
    ...
    /***/ 345: /***/ function(
          ...
          Object(external_this_wp_element_["createElement"])(
            external_this_wp_components_["ClipboardButton"],
            {
              ...
              onCopy: function onCopy() {
                ...
                createNotice(
                  "info",
                  Object(external_this_wp_i18n_["__"])("All content copied."),
                  {
                    isDismissible: true,
                    type: "snackbar"
                  }
      ...
      function getActiveGeneralSidebarName(state) {
        ...
        var isDismissed = selectors_getPreference(
          state,
      ...
      function isPluginItemPinned(state, pluginName) {
        var pinnedPluginItems = selectors_getPreference(
          state,
          "pinnedPluginItems",
          {}
        );
      ...
      var effects = {
        SET_META_BOXES_PER_LOCATIONS: function SET_META_BOXES_PER_LOCATIONS(
          ...
          var wasAutosavingPost = Object(external_this_wp_data_["select"])(
            "core/editor"
          ).isAutosavingPost(); // Meta boxes are initialized once at page load. It is not necessary to
          ...
          var hasActiveMetaBoxes = Object(external_this_wp_data_["select"])(
            "core/edit-post"
          ).hasMetaBoxes(); // First remove any existing subscription in order to prevent multiple saves

          if (!!saveMetaboxUnsubscribe) {
            saveMetaboxUnsubscribe();
          } // Save metaboxes when performing a full save on the post.

          saveMetaboxUnsubscribe = Object(external_this_wp_data_["subscribe"])(
            function() {
      ...
      function VisualEditor() {
        return Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            external_this_wp_blockEditor_["Typewriter"],
            null,
            Object(external_this_wp_element_["createElement"])(
      ...
      function BlockManagerCategory(_ref) {
        ...
        var settings = Object(external_this_wp_element_["useContext"])(
          edit_post_settings
        );
        var allowedBlockTypes = settings.allowedBlockTypes;
        var filteredBlockTypes = Object(external_this_wp_element_["useMemo"])(
          function() {
      ...
      function CustomFieldsConfirmation(_ref) {
        ...
        return Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            ...
            willEnable
              ? Object(external_this_wp_i18n_["__"])("Enable & Reload")
              : Object(external_this_wp_i18n_["__"])("Disable & Reload")
          )
        );
      }
      ...
      var enable_plugin_document_setting_panel_createSlotFill = Object(
          external_this_wp_components_["createSlotFill"]
        )("EnablePluginDocumentSettingPanelOption"),
        Fill = enable_plugin_document_setting_panel_createSlotFill.Fill,
        enable_plugin_document_setting_panel_Slot =
          enable_plugin_document_setting_panel_createSlotFill.Slot;
      ...
      var settings_header_SettingsHeader = function SettingsHeader(_ref) {
        ...
        var _ref4 =
            sidebarName === "edit-post/block" // translators: ARIA label for the Settings Sidebar tab, selected.
              ? [
      ...
      function PostLink(_ref) {
        ...
        return Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            ...
            postTypeLabel || Object(external_this_wp_i18n_["__"])("View Post")
          ),
          Object(external_this_wp_element_["createElement"])(
            "div",
            {
      ...
      var plugin_document_setting_panel_createSlotFill = Object(
          external_this_wp_components_["createSlotFill"]
        )("PluginDocumentSettingPanel"),
        plugin_document_setting_panel_Fill =
          plugin_document_setting_panel_createSlotFill.Fill,
        plugin_document_setting_panel_Slot =
          plugin_document_setting_panel_createSlotFill.Slot;

      var plugin_document_setting_panel_PluginDocumentSettingFill = function PluginDocumentSettingFill(
        _ref
      ) {
        var isEnabled = _ref.isEnabled,
          panelName = _ref.panelName,
      ...
      var PluginPostPublishPanel = Object(external_this_wp_compose_["compose"])(
        Object(external_this_wp_plugins_["withPluginContext"])(function(
          context,
          ownProps
        ) {
 ...
 */
      ...
      var PluginPrePublishPanel = Object(external_this_wp_compose_["compose"])(
        Object(external_this_wp_plugins_["withPluginContext"])(function(
          context,
          ownProps
        ) {
      ...
      function Layout(_ref) {
        ...
        return Object(external_this_wp_element_["createElement"])(
          ...
          Object(external_this_wp_element_["createElement"])(
            external_this_wp_editor_["LocalAutosaveMonitor"],
            null
          ),
      ...
      var listener_hooks_useAdjustSidebarListener = function useAdjustSidebarListener(
        postId
      ) {
        var _useSelect2 = Object(external_this_wp_data_["useSelect"])(
            function(select) {
              return {
        ...
        var sidebarToReOpenOnExpand = Object(
      ...
      var listener_hooks_useUpdatePostLinkListener = function useUpdatePostLinkListener(
        ...
        var _useSelect3 = Object(external_this_wp_data_["useSelect"])(
            function(select) {
              return {
            ...
            },
            {
              ...
              value: function render() {
                var _this$props = this.props,
                  ...
                  preferredStyleVariations =
                    _this$props.preferredStyleVariations,
                  __experimentalLocalAutosaveInterval =
                    _this$props.__experimentalLocalAutosaveInterval,
      ...
      /* harmony default export */ var editor = Object(
        ...
        Object(external_this_wp_data_["withDispatch"])(function(dispatch) {
          var _dispatch = dispatch("core/edit-post"),
            updatePreferredStyleVariations =
              _dispatch.updatePreferredStyleVariations;
      ...
      /* concated harmony reexport PluginDocumentSettingPanel */ __webpack_require__.d(
        __webpack_exports__,
        "PluginDocumentSettingPanel",
        function() {
