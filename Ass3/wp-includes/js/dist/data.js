    ...
    /***/ 348: /***/ function(
      ...
      function createNamespace(key, options, registry) {
        ...
        var selectors = mapSelectors(
          Object(objectSpread["a" /* default */])(
            ...
            Object(external_lodash_["mapValues"])(options.selectors, function(
              selector
            ) {
      ...
      function createReduxStore(key, options, registry) {
        ...
        if (options.controls) {
          ...
          middlewares.push(
            external_this_wp_reduxRoutine_default()(normalizedControls)
          );
        }
                  ...
                  return regenerator_default.a.wrap(function _callee$(
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 3:
                          (_store$__unstableOrig = store.__unstableOriginalGetState()),
                            (metadata = _store$__unstableOrig.metadata);

                          if (
                            !hasStartedResolution(metadata, selectorName, args)
                          ) {
                            _context.next = 6;
                            break;
                          }
                        ...
                        case 6:
                          ...
                          return fulfillResolver.apply(
                            void 0,
                            [store, mappedResolvers, selectorName].concat(args)
                          );
            ...
            return regenerator_default.a.wrap(function _callee2$(_context2) {
              while (1) {
                switch ((_context2.prev = _context2.next)) {
                  case 0:
                    resolver = Object(external_lodash_["get"])(resolvers, [
                      selectorName
                    ]);
      ...
      function createCoreDataStore(registry) {
        var getCoreDataSelector = function getCoreDataSelector(selectorName) {
          return function(reducerKey) {
            ...
            return (_registry$select = registry.select(reducerKey))[
              selectorName
        ...
        var getCoreDataAction = function getCoreDataAction(actionName) {
          return function(reducerKey) {
            ...
            return (_registry$dispatch = registry.dispatch(reducerKey))[
              actionName
      ...
      var persistence_persistencePlugin = function persistencePlugin(
        ...
        return {
          registerStore: function registerStore(reducerKey, options) {
            ...
            store.subscribe(
              createPersistOnChange(store.getState, reducerKey, options.persist)
            );
            return store;
          }
        };
      ...
      persistence_persistencePlugin.__unstableMigrate = function(
        ...
        var insertUsage = Object(external_lodash_["get"])(persistence.get(), [
          "core/editor",
          "preferences",
          "insertUsage"
        ]);
      ...
      var context_Context = Object(external_this_wp_element_["createContext"])(
        false
      );
      ...
      var useIsomorphicLayoutEffect =
        typeof window !== "undefined"
          ? external_this_wp_element_["useLayoutEffect"]
          : external_this_wp_element_["useEffect"];
      ...
      function useSelect(_mapSelect, deps) {
        var mapSelect = Object(external_this_wp_element_["useCallback"])(
          _mapSelect,
          deps
        );
        var registry = useRegistry();
        var isAsync = useAsyncMode();
        var queueContext = Object(external_this_wp_element_["useMemo"])(
          function() {
            return {
              queue: true
            };
        ...
        var _useReducer = Object(external_this_wp_element_["useReducer"])(
            function(s) {
              return s + 1;
            },
            0
          ),
          _useReducer2 = Object(slicedToArray["a" /* default */])(
            _useReducer,
            2
          ),
        ...
        var latestIsAsync = Object(external_this_wp_element_["useRef"])(
          isAsync
        );
        var latestMapOutput = Object(external_this_wp_element_["useRef"])();
        var latestMapOutputError = Object(
        ...
        try {
          ...
          var errorMessage = "An error occurred while running 'mapSelect': ".concat(
            error.message
          );
      ...
      var with_select_withSelect = function withSelect(mapSelectToProps) {
        return Object(external_this_wp_compose_["createHigherOrderComponent"])(
          function(WrappedComponent) {
            return Object(external_this_wp_compose_["pure"])(function(
              ownProps
            ) {
      ...
      var use_dispatch_with_map_useIsomorphicLayoutEffect =
        typeof window !== "undefined"
          ? external_this_wp_element_["useLayoutEffect"]
          : external_this_wp_element_["useEffect"];
      /**
      ...
      var use_dispatch_with_map_useDispatchWithMap = function useDispatchWithMap(
        dispatchMap,
        deps
      ) {
        var registry = useRegistry();
        var currentDispatchMap = Object(external_this_wp_element_["useRef"])(
          dispatchMap
        );
        ...
        return Object(external_this_wp_element_["useMemo"])(function() {
          var currentDispatchProps = currentDispatchMap.current(
            registry.dispatch,
            registry
          );
          return Object(external_lodash_["mapValues"])(
            ...
            function(dispatcher, propName) {
              if (typeof dispatcher !== "function") {
                ...
                console.warn(
                  "Property ".concat(
                    propName,
                    " returned from dispatchMap in useDispatchWithMap must be a function."
                  )
                );
              }
              ...
              return function() {
                ...
                return (_currentDispatchMap$c = currentDispatchMap.current(
                  registry.dispatch,
                  registry
                ))[propName].apply(_currentDispatchMap$c, arguments);
              };
            }
          );
        }, [registry].concat(
          Object(toConsumableArray["a" /* default */])(deps)
        ));
      };
      ...
      function createRegistrySelector(registrySelector) {
        var selector = function selector() {
          return registrySelector(selector.registry.select).apply(
            void 0,
            arguments
          );
        };
      ...
      /* concated harmony reexport useRegistry */ __webpack_require__.d(
        __webpack_exports__,
        "useRegistry",
        function() {
          return useRegistry;
      ...
      /* concated harmony reexport useSelect */ __webpack_require__.d(
        __webpack_exports__,
        "useSelect",
        function() {
          return useSelect;
      ...
      /* concated harmony reexport useDispatch */ __webpack_require__.d(
        __webpack_exports__,
        "useDispatch",
        function() {
          return use_dispatch;
